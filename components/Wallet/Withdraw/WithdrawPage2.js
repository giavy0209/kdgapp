                        ...
                        <View style={WithdrawStyle.numberSendContainer}>
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                                <View style={{ flexDirection: 'row' }}>
                                    <Image source={coinName === 'KDG' ? kdgicon : coinName === 'TRX' ? trxicon : coinName === 'ETH' ? ethicon : coinName === 'USDT-TRC20' || coinName==='USDT-ERC20' ? usdticon : coinName === 'KNC' ? kncicon : coinName === 'TOMO' ? tomoicon : coinName === 'MCH' ? mchicon : btcicon} style={{ width: windowWidth * windowHeight / 9000, height: windowWidth * windowHeight / 9000 }} />
