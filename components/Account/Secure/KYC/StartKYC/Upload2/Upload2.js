        ...
        <>
            ...
            style={[mainStyles.container,{paddingHorizontal: 14, paddingVertical: 10,}]}>
                ...
                <View style={{flexDirection:'row', alignItems: 'center', marginTop: 33, justifyContent:'space-between', position: 'relative'}}>
                    ...
                    <Text style={[mainStyles.fontsize12, mainStyles.color3, {width: '60%'}]}>1.Ảnh chụp hộ chiếu</Text>
                ...
                <View style={{flexDirection:'row', alignItems: 'center', marginTop: 33, justifyContent:'space-between', position: 'relative'}}>
                    ...
                    <Text style={[mainStyles.fontsize12, mainStyles.color3, {width: '60%'}]}>2. Ảnh có mặt bạn chụp chung Hộ chiếu và một tờ giấy ghi chữ "KINGDOM GAME 4.0", ngày tháng năm hiện tại và chữ ký của bạn.</Text>
