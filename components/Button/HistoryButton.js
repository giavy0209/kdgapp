            ...
            >
                <View style={{flexDirection: 'row'}}>
                    ...
                    <View style={{paddingLeft: 10}}>
                        <Text style={{color: 'rgba(255,255,255,0.8)', fontSize: 14}}>{type === 'deposit' ? checkLanguage({vi: 'Nạp', en: 'Deposit'},language) : type === 'withdraw' ? checkLanguage({vi: 'Rút', en: 'Withdraw'},language) : 'Không xác định'}</Text>
