        ...
        <View style={{padding: 15}}>
            ...
            <View style={{paddingTop: 10}}>
                ...
                </View>
                {
                    ...
                    :
                    <View style={{padding: 10}}>
                        <Text style={{color: display === 1 ? '#8a8c8e'  :'rgba(255,255,255,0.7)', fontSize: 14}}>
                            {checkLanguage({vi: 'Tỷ lệ: 1 KDG = 2 KDG reward ', en: 'Ratio: 1 KDG = 2 KDG rewards '},language)}
                        </Text>
                        <Text style={{color: display === 1 ? '#8a8c8e'  :'rgba(255,255,255,0.7)', fontSize: 14, paddingTop: 20}}>
                            {checkLanguage({vi: 'Mỗi lần được swap tối đa 200 KDG. Tối thiểu 2 KDG.', en: 'Maximum 200 KDG and Minimum 2 KDG for each swap.'},language)}
                        </Text>
                        <Text style={{color: display === 1 ? '#8a8c8e'  :'rgba(255,255,255,0.7)', fontSize: 14, paddingTop: 20}}>
                            {checkLanguage({vi: 'Mỗi ngày swap tối đa 5 lần/tài khoản.', en: 'Swap up to 5 times per day per account.'},language)}
                        </Text>
                    </View>
                }
            </View>
